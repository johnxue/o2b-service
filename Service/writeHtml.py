...
class Handler(WebRequestHandler):
    ...
    def post(self) :
        try :
            ...
            if objData['action']=='htmlContent':
                mode=objData['htmlContent']['content']['mode']
                gid=objData['htmlContent']['content']['gid']
                tid=objData['htmlContent']['content']['tid']
                cid=objData['htmlContent']['content']['cid']
                rid=objData['htmlContent']['content']['rid']
                content=objData['htmlContent']['content']
